                ...
                {ProductData.map((i, index)=> index>3 & index<8 ?
                    <div className='w-[23%] h-[100%] rounded-xl  bg-[#FAFAFA]'>
                        <div className='h-[75%] w-[100%] relative '>
                            ...
                            <div className='bg-yellow-400 absolute -bottom-3 left-12 h-[4vh] rounded-md text-[black] text-[14px] font-[700] flex items-center justify-center w-[30vh]'>Noice Cancellation</div>
                        </div>
                        <div className='h-[25%] w-[100%]  rounded-b-xl flex gap-3 pt-4 flex-col items-center justify-center'>
                            <div className='h-[20%] w-[100%] flex justify-between '>
                                <b1 className='font-[600] ml-3'>boAt Nirvana Ion ANC Limited Edition </b1>
                                
                            </div>
                            <div className='h-[50%] w-[100%] flex'>
                                <div className='h-[100%] w-[60%] '>
                                    <div className='h-[50%] w-[100%] flex items-center gap-1'>
                                        <h1 className='font-[700] text-[17px] pl-4'><i class="fa fa-inr" aria-hidden="true"></i>3,499</h1>
                                        <h3 className='text-[gray] line-through text-[12px]'><i class="fa fa-inr" aria-hidden="true"></i>11,999</h3>
